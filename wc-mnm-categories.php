...
class WC_MNM_Categories {
	...
	public static function admin_scripts() {
		...
		if ( 'product' === $screen_id ) {
			...
			wp_enqueue_script( 'wc_mnm_categories_writepanel', self::plugin_url() . '/assets/js/admin/wc-mnm-categories-metabox'  . $suffix . '.js', array( 'jquery', 'wc-enhanced-select' ), $version, true );
